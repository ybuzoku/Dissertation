...
\end{defn}
It turns out that this integer $d$ is independent of chosen point $y \in Y$, a proof of which can be found in \cite[Proposition 7]{donaldson}, and thus is an invariant of the map $F$. We call this $d$ the \emph{degree} of the map $F$. The theory thus developed gives us a nice extension of our definition of meromorphic functions on Riemann surfaces.
