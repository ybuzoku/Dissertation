...
\begin{figure*}[ht!]
  \begin{subfigure}[h]{0.3\textwidth}
    \centering
    \includegraphics[width=1\textwidth]{800px-Heptagonal_tiling.png}
  \end{subfigure}
  \hfill
  \begin{subfigure}[h]{0.3\textwidth}
    \centering
    \includegraphics[width=1.4\textwidth]{1024px-PavageDemiPlanPoincare.png}
  \end{subfigure}
  \hfill
  \captionsetup{labelformat=empty}
...
\begin{figure*}[ht!]
  \begin{subfigure}[b]{0.3\textwidth}
    \centering
    \includegraphics[width=1.3\textwidth]{escherDisk.jpg}
  \end{subfigure}
  \hfill
